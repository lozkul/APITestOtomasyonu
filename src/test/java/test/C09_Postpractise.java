...
public class C09_Postpractise {
    ...
    */
    ...
    public void put01(){
        ...
        innerBody.put("checkin","2022-12-17");
        innerBody.put("checkout","2022-12-25");
        reqBody.put("firstname", "hasmet");
        reqBody.put("lastname", "celik");
        reqBody.put("totalprice" , 2000);
       ...
       /* response.
                ...
                body("booking.firstname", equalTo("hasmet"),
                        ...
                        "booking.totalprice",equalTo(2000),
                        "booking.depositpaid", equalTo(true),
                        "booking.bookingdates.checkin",equalTo("2022-12-17"),
                        "booking.bookingdates.checkout",equalTo("2022-12-25"),
                        "booking.additionalneeds",equalTo("sahur"));
*/
    }
